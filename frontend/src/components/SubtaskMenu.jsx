...
export const SubtaskMenu = ({ x, y, sub, displayNumber, onAction, onClose }) => {
  ...
  const items = [
    ...
    { icon: Plus, label: "Alt görev ekle", color: "text-violet-300 hover:bg-violet-500/15", action: "add-child" },
  ...
  return createPortal(
    <motion.div
      ...
      className="fixed z-[130] glass-panel border border-sertex-cyan/40 rounded-md py-1 shadow-lg min-w-[210px]"
      style={{
        left: pos.left,
        top: pos.top,
